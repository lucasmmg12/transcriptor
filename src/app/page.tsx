                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <div className="flex gap-4">
                                <a href="https://wa.me/5492645438114" target="_blank" title="WhatsApp" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-300 hover:bg-emerald-500 hover:text-white transition-all border border-white/10 shadow-sm">
                                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                                        <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-1.146 4.19 4.189-1.098z"/>
                                    </svg>
                                </a>
                                <a href="https://instagram.com/growlabs.lat" target="_blank" title="Instagram" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-300 hover:bg-emerald-500 hover:text-white transition-all border border-white/10 shadow-sm">
                                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                                ...
                                <a href="https://www.linkedin.com/company/grow-labs-latam/" target="_blank" title="LinkedIn" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-300 hover:bg-emerald-500 hover:text-white transition-all border border-white/10 shadow-sm">
                                    <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
