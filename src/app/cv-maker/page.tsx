...
interface Job {
    ...
    year: string;
    company: string;
    description: string; // Permitir saltos de línea para viñetas
}
...
const INITIAL_DATA: CVData = {
    personalInfo: {
        firstName: "FLORENCIA",
        lastName: "LEYRO",
        title: "Gestión Administrativa • Dirección Comercial • Ventas",
        birthDate: "13/10/1992",
        familyStatus: "Madre de 2 hijos",
        phone: "264-462-1887",
        email: "flori.mendoza13@gmail.com",
        instagram: "@florileyromendoza",
        location: "Rivadavia, San Juan",
        imageUrl: "https://i.imgur.com/fBkYbSu.jpeg"
    },
    profile: "Profesional de 33 años experta en potenciar relaciones comerciales mediante la venta consultiva y la escucha activa. Mi carrera evolucionó de roles operativos a la fundación y dirección de una empresa líder en su rubro. Especialista en liderazgo de grandes equipos y posicionamiento estratégico de productos, enfocada en el desarrollo de canales digitales y la fidelización de clientes para maximizar el rendimiento comercial.",
    experience: [
        {
            id: "1",
            role: "Dueña y Directora General",
            year: "2020 - Actualidad",
            company: "El Rinconcito Pañalera & E-Commerce",
            description: "• Posicionamiento Estratégico: Diseño y ejecución de estrategias de producto y marca que impulsaron la expansión nacional.\n• Gestión integral y liderazgo de equipo de 18 colaboradores.\n• Desarrollo de e-commerce con logística a nivel país.\n• Liquidación de sueldos, impuestos y negociación proveedores."
        },
        {
            id: "2",
            role: "Administrativa de Ventas",
            year: "2018 - 2021",
            company: "Óptica Científica S.A.",
            description: "• Facturación compleja de Obras Sociales y Prepagas.\n• Manejo de caja, cuentas corrientes y conciliaciones.\n• Coordinación de apertura operativa de nuevas sucursales."
        },
        {
            id: "3",
            role: "Encargada de Sucursal",
            year: "2012 - 2018",
            company: "Centro Óptico San Juan",
            description: "Supervisión operativa, control de stock estratégico y liderazgo del equipo de ventas."
        }
    ],
    education: [
        { id: "1", title: "Lic. Mercadotecnia", institution: "Univ. TECH (España)", detail: "En curso" },
        { id: "2", title: "Comercio Internac.", institution: "Cámara Comercio Arg", detail: "3º Año" },
        { id: "3", title: "Admin. de Empresas", institution: "UNSJ", detail: "2º Año" }
    ],
    skills: ["Estrategia", "Liderazgo", "Ventas", "Fidelización", "Facturación", "E-Commerce"],
    courses: [
        { id: "1", name: "Coaching Ontológico", institution: "Axion Trading (En curso)" },
        { id: "2", name: "Oratoria", institution: "Coder House (En curso)" },
        { id: "3", name: "Liquidación Sueldos", institution: "Instituto INSRI (2014)" },
        { id: "4", name: "Marketing Digital", institution: "2021" },
        { id: "5", name: "Habilidades Blandas", institution: "Prof. Franco Pisso 2025" }
    ],
    languagesAndSoftware: "• Paquete Office (Excel Avanzado)\n• Sistemas de Gestión (CRM/ERP)\n• Canva y Herramientas de Diseño"
};
        ...
        <div className="min-h-screen bg-gray-900 text-white flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-1/3 p-6 overflow-y-auto h-screen border-r border-gray-700 bg-gray-800">
                <div className="flex justify-between items-center mb-6">
                    ...
                    <a href="/" className="text-xs text-gray-400 hover:text-white"> &larr; Volver</a>
                </div>
