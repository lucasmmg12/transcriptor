...
const SOLUTIONS = [
    {
        id: 'automations',
        title: "M├│dulos de Automatizaci├│n",
        icon: "cogs",
        ...
        features: [
            "Reducci├│n del 90% en tiempo de gesti├│n",
            "Eliminaci├│n de errores humanos",
            "Integraci├│n con tus sistemas actuales"
        ],
        details: {
            theoretical: "La automatizaci├│n de procesos empresariales (BPA) consiste en el uso de tecnolog├¡a para ejecutar tareas y flujos de trabajo recurrentes con m├¡nima intervenci├│n humana. Se busca reemplazar la ejecuci├│n manual de procesos administrativos por reglas l├│gicas ejecutadas por software (RPA - Robotic Process Automation).",
            practical: "Imagina tener un 'empleado robot' invisible que no duerme. En lugar de que una persona copie datos de un email y los pegue en un Excel, un script lo hace instant├íneamente. Conecta sistemas que normalmente no hablan entre s├¡ (ej. tu banco con tu sistema contable, o tu email con tu CRM).",
            example: "Una empresa de log├¡stica recib├¡a 500 pedidos diarios por WhatsApp. Antes, 4 empleados los cargaban manualmente, tardando 6 horas. Con nuestra automatizaci├│n, el pedido se extrae del chat, se carga en el ERP, y se generan la factura y la hoja de ruta de despacho en 30 segundos, reduciendo el error humano a 0% y liberando al staff para ventas."
        }
    },
    {
        id: 'rag',
        ...
        description: "Tu base de conocimiento institucional potenciada por IA. Convierte manuales y procesos en respuestas instant├íneas.",
        features: [
            "B├║squeda en toda tu documentaci├│n",
            "Respuestas contextualizadas y citadas",
            "Onboarding de empleados acelerado"
        ],
        details: {
            theoretical: "RAG (Retrieval-Augmented Generation) es una arquitectura de Inteligencia Artificial que combina grandes modelos de lenguaje (LLMs como GPT) con una base de conocimientos privada y vectorial. Permite que la IA 'aprenda' y responda espec├¡ficamente sobre los datos privados de una organizaci├│n, citando fuentes.",
            practical: "Es como darle un cerebro a tus archivos PDF, Excels y manuales. Puedes 'chatear' con toda la documentaci├│n de tu empresa. Un empleado le pregunta '┬┐Cu├íl es el procedimiento de devoluci├│n para clientes VIP?' y el sistema responde citando la p├ígina exacta del manual de operaciones, en lugar de alucinar informaci├│n.",
            example: "Una aseguradora con miles de p├íginas de condiciones generales. Los agentes de soporte tardaban 20 minutos en buscar coberturas espec├¡ficas. Con RAG, escriben la consulta y obtienen la respuesta precisa junto con la cl├íusula contractual en 5 segundos, aumentando la satisfacci├│n del cliente y la velocidad de resoluci├│n."
        }
    },
    {
        id: 'apps',
        ...
        description: "Suite completa de aplicaciones para conectar clientes, colaboradores y administraci├│n.",
        features: [
            "Portal de Clientes: Autogesti├│n",
            "Gestor de Proyectos: Trazabilidad",
            "Asistente de Reuniones: IA Transcriptor"
        ],
        details: {
            theoretical: "El desarrollo de interfaces digitales personalizadas (Web & Mobile Apps) sirve como punto de contacto e interacci├│n entre la empresa y sus stakeholders. Centralizan datos, operaciones y comunicaciones en la nube, permitiendo acceso ubicuo y trazabilidad total.",
            practical: "Olvida los papeles perdidos y las planillas de Excel compartidas por email. Es crear tu propia plataforma (como tu propio Uber o Homebanking interno) donde tus clientes inician sesi├│n para ver el estado de sus pedidos, o tus empleados marcan asistencia y suben reportes desde el celular.",
            example: "Una constructora gestionaba el avance de obra con papeles que se perd├¡an y fotos de WhatsApp desorganizadas. Implementamos una App Web Progresiva (PWA) donde los capataces suben reportes diarios geo-referenciados. Los inversores ven el avance en tiempo real desde un dashboard, aumentando la transparencia y confianza."
        }
    },
    {
        id: 'chatbot',
        ...
        description: "Atiende a tus clientes 24/7 con inteligencia real, no men├║s frustrantes. Vende, agenda y resuelve dudas.",
        features: [
            "Atenci├│n personalizada 24/7",
            "Sin ├írboles de decisi├│n r├¡gidos",
            "Gesti├│n de turnos y ventas"
        ],
        details: {
            theoretical: "Agentes conversacionales avanzados implementados sobre la API de WhatsApp Business. Utilizan Procesamiento de Lenguaje Natural (NLP) avanzado para interpretar la intenci├│n y el sentimiento del usuario, mantener el contexto de la conversaci├│n (memoria) y ejecutar acciones complejas mediante integraci├│n de APIs.",
            practical: "No es el t├¡pico chatbot de 'Marque 1 para ventas'. Es un asistente que habla natural, entiende audios, maneja iron├¡a y empat├¡a. Puede agendar citas en tu calendario real, enviar cat├ílogos personalizados y cerrar ventas a las 3 de la ma├▒ana mientras tu equipo duerme.",
            example: "Una cl├¡nica m├®dica saturada por llamadas telef├│nicas para turnos. Implementamos un agente de IA en WhatsApp que atiende a 1000 pacientes simult├íneos, verifica disponibilidad en el sistema de agenda m├®dica, confirma cobertura de obras sociales y reserva el turno. Redujo el ausentismo en un 40% (recordatorios) y descomprimi├│ la recepci├│n."
        }
    },
    {
        id: 'web-design',
        ...
        description: "Experiencias web totalmente personalizadas, dise├▒adas con neuromarketing para convertir visitantes en clientes.",
        features: [
            "Dise├▒o 100% Personalizado y Responsivo",
            "Estrategia UX/UI basada en Estad├¡sticas",
            "SEO T├®cnico & Velocidad Extrema"
        ],
        details: {
            theoretical: "No hacemos 'p├íginas web', construimos activos digitales. Combinamos las mejores pr├ícticas de desarrollo moderno (Next.js, React) con principios de psicolog├¡a del consumidor y Neuromarketing. Cada elemento visual tiene un prop├│sito estrat├®gico: guiar la atenci├│n del usuario hacia la conversi├│n.",
            practical: "Olv├¡date de las plantillas gen├®ricas que tiene tu competencia. Creamos un traje a medida para tu marca. Desde animaciones impactantes que retienen la atenci├│n, hasta una arquitectura de informaci├│n que facilita la venta. Tu sitio se ver├í perfecto en celulares, cargar├í en milisegundos y estar├í optimizado para que Google te ame.",
            example: "Una firma legal con un sitio web anticuado apenas recib├¡a consultas online. Redise├▒amos su presencia digital con una est├®tica autoritaria y moderna, optimizada para m├│viles y con funnels de conversi├│n claros. En 2 meses, aumentaron su captaci├│n de leads cualificados en un 300% y mejoraron su posicionamiento en b├║squedas locales."
        }
    }
];
        ...
        <div className="font-sans text-white selection:bg-green-500 selection:text-black scroll-smooth">
                ...
                <div className="container mx-auto px-6 max-w-4xl text-center">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 text-left">
                        ...
                        <div className="p-6 rounded-2xl bg-white/5 border border-white/5">
                            ...
                            <p className="text-sm text-gray-400">Precisi├│n Operativa ÔÇó Adaptaci├│n Local ÔÇó Innovaci├│n Transparente</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6 max-w-6xl">
                    <div className="flex flex-col md:flex-row gap-16">
                        ...
                        <div className="w-full md:w-1/2">
                            <h3 className="text-3xl font-bold mb-8">┬┐Tu empresa est├í perdiendo dinero sin saberlo?</h3>
            ...
            <section id="faq" className="py-20 px-6 bg-black">
                <div className="container mx-auto max-w-3xl">
                    ...
                    <div className="space-y-4">
                        {[
                            { q: "┬┐Cu├ínto tiempo toma la implementaci├│n?", a: "La implementaci├│n completa toma entre 15-30 d├¡as dependiendo del tama├▒o de tu empresa. Comenzar├ís a ver resultados desde la primera semana." },
                            { q: "┬┐Es compatible con mi software actual?", a: "S├¡, Grow Labs se integra perfectamente con CRMs, ERPs y sistemas legacy a trav├®s de APIs o RPA. No necesitas cambiar tu infraestructura." },
                            { q: "┬┐C├│mo garantizan la seguridad de los datos?", a: "Utilizamos encriptaci├│n de nivel bancario y cumplimos con normativas internacionales de protecci├│n de datos." },
                            { q: "┬┐Qu├® pasa si no funciona para mi industria?", a: "Ofrecemos una garant├¡a de 90 d├¡as. Si no ves resultados, te devolvemos el 100% de la inversi├│n." }
                        ].map((faq, i) => (
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12 mb-20 animate-fade-in">
                        <div className="md:w-1/2 text-left">
                            ...
                            <p className="text-gray-400 text-lg leading-relaxed mb-8">
                                Tecnolog├¡a de ├®lite al alcance de todos. Potencia tu productividad y carrera con nuestra suite open access, dise├▒ada originalmente para uso interno y ahora disponible para ti.
                            </p>
                            ...
                            <div className="glass-card p-6 rounded-2xl max-w-sm w-full transform rotate-3 hover:rotate-0 transition-all duration-500 hover:shadow-2xl hover:shadow-green-500/20 border border-white/10 bg-black/60 relative group-card">
                                ...
                                <div className="space-y-4 mb-6">
                                    <p className="text-gray-300 text-sm leading-relaxed font-light">
                                        "En <span className="text-green-400 font-bold">Grow Labs</span> creemos que la IA debe ser accesible. Por eso liberamos nuestras mejores herramientas internas para que vos tambi├®n puedas automatizar tu trabajo."
                                    </p>
                    ...
                    <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-8">
                        ...
                        <div className="glass-card p-8 rounded-3xl border border-white/5 hover:border-grow/30 transition-all group relative overflow-hidden flex flex-col">
                            <div className="absolute top-0 right-0 p-3 bg-white/5 rounded-bl-2xl backdrop-blur-md border-b border-l border-white/5 z-10">
                                <span className="text-xs font-bold text-grow">M├üS POPULAR</span>
                            </div>
                            ...
                            <p className="text-gray-400 mb-8 text-sm leading-relaxed flex-1">
                                Dise├▒a un curr├¡culum profesional, validado por expertos y optimizado para ATS. Incluye formatos de exportaci├│n premium y dise├▒o de alto impacto.
                            </p>
                        ...
                        <div className="glass-card p-8 rounded-3xl border border-white/5 hover:border-blue-500/30 transition-all group relative overflow-hidden flex flex-col">
                            ...
                            <p className="text-gray-400 mb-8 text-sm leading-relaxed flex-1">
                                Convierte audios de reuniones, entrevistas o WhatsApp a texto en segundos. Obt├®n res├║menes autom├íticos, minutas y detecci├│n de hablantes con GPT-4.
                            </p>
                        ...
                        <div className="glass-card p-8 rounded-3xl border border-white/5 hover:border-purple-500/30 transition-all group relative overflow-hidden flex flex-col">
                            ...
                            <p className="text-gray-400 mb-8 text-sm leading-relaxed flex-1">
                                Transforma textos o ideas en presentaciones visuales completas. Exporta a PDF con dise├▒os art├¡sticos estilo "Visual Novel" o corporativos.
                            </p>
                        ...
                        <div className="glass-card p-8 rounded-3xl border border-white/5 hover:border-orange-500/30 transition-all group relative overflow-hidden flex flex-col">
                            ...
                            <p className="text-gray-400 mb-8 text-sm leading-relaxed flex-1">
                                Convierte tus fotos (DNI, documentos) en un PDF ├║nico y ordenado. Procesamiento 100% privado en tu navegador.
                            </p>
                    ...
                    <div className="bg-neutral-900 border border-white/10 rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative shadow-2xl shadow-black" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="p-8 space-y-8">
                            ...
                            <div className="flex gap-6 flex-col md:flex-row">
                                ...
                                <div>
                                    <h4 className="text-lg font-bold text-white mb-2">Definici├│n Te├│rica</h4>
                            ...
                            <div className="flex gap-6 flex-col md:flex-row">
                                ...
                                <div>
                                    <h4 className="text-lg font-bold text-white mb-2">En la Pr├íctica</h4>
                            ...
                            <div className="p-6 bg-gradient-to-br from-white/5 to-transparent rounded-xl border border-white/5">
                                <div className="flex gap-4 items-start">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-bold text-white mb-2">Caso de ├ëxito</h4>
                        ...
                        <div className="p-6 border-t border-white/10 bg-black/20 flex justify-end gap-4">
                            ...
                            <a href="https://wa.me/5492645438114" target="_blank" className="px-6 py-3 rounded-xl bg-grow text-black font-bold hover:bg-green-400 transition-colors hover:shadow-[0_0_20px_rgba(0,255,136,0.3)] flex items-center gap-2">
                                <span>Solicitar esta Soluci├│n</span>
